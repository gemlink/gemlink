...
public:
    CMainParams()
    {
        ...
        checkpointData = (CCheckpointData){
            ...
            1691635205, // * UNIX timestamp of last checkpoint block
            5571487,    // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            2732        // * estimated number of transactions per day after checkpoint
